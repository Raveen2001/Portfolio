export default function ContactComponent() {
  return (
    <section className="bg-primary" style={{ height: "75vh" }}>
      <div className="flex flex-col items-center pt-10">
        ...
        <form className="mt-20">
          ...
          <div className="flex justify-end">
            <input
              type={"submit"}
              className="mt-5 outline outline-2 outline-secondary text-secondary px-4 py-2 hover:bg-accent hover:outline-accent transition-all duration-500"
            />
          </div>
        </form>
      </div>
